...
const meta: Meta<typeof RecordPosterCardBottom> = {
  title: "features/record-list/RecordPosterCardBottom",
  component: RecordPosterCardBottom,
...
export default meta;
type Story = StoryObj<typeof RecordPosterCardBottom>;
